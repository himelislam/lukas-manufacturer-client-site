...
const ContactUs = () => {
    return (
        <section class="relative py-20 2xl:py-40 bg-primary">
                                ...
                                <div class="w-full lg:w-1/2 px-4">
                                    <div class="py-6 px-8 mb-4 bg-gray-600 rounded-lg">
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-lg font-bold text-white">+88 017 00111111</p>
                                        </div>
                                    </div>
                                    <div class="py-6 px-8 mb-10 bg-gray-600 rounded-lg">
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-lg font-bold text-white">support@lukas.manufacturer.com</p>
                                        </div>
                                    </div>
                                    <div class="py-6 px-8">
                                        <div class="flex">
                                            ...
                                            <div>
                                                <div class="pb-4 pr-16 mb-6 border-b border-gray-500">
                                                    <p class="text-lg font-bold text-white">Akhalia, Sylhet</p>
                                                    <p class="text-lg font-bold text-white">3100, BD</p>
                                                </div>
                                                <p class="text-gray-400">We Provide the best tools for your service</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
