...
const Tooltip = memo(() => {
    return (
        <>
            <div data-dial-init className="fixed end-6 bottom-6 group px-4">
                <div id="speed-dial-menu-default" className="flex flex-col items-center hidden group-hover:block mb-4 space-y-2">
                ...
                <button type="button" data-dial-toggle="speed-dial-menu-default" aria-controls="speed-dial-menu-default" aria-expanded="false" className="flex items-center justify-center text-white bg-blue-700 rounded-full w-14 h-14 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800 group">
